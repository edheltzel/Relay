...
assistant_dir = "/srv/relay-assistant"
"#,
        )
        .unwrap();
        ...
        assert_eq!(cfg.assistant_dir, "/srv/relay-assistant");
...
[telegram]
bot_token_env = "RELAY_TEST_TOKEN"
allow_user_ids = [7]
allow_chat_ids = [9]
"#,
        )
        ...
        assert_eq!(cfg.telegram_bot_token_env, "RELAY_TEST_TOKEN");
