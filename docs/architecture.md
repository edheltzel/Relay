...
relay is one local Rust process. It polls iMessage or Telegram, filters messages,
...
`full-access` is explicit. Relay translates the common capability into backend
