...
relay is one local Rust process. It polls Messages, filters messages, loads the
...
relay reads local message state and shells out to local commands. It opens no
