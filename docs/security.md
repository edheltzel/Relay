...
service user. Relay requires a fixed, existing work directory and rejects overlap
with Relay-owned files, including the loaded config file. Keep allowed senders
...
This protects proposals submitted through Relay's drafts directory. It is not a
