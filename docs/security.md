...
| `inherit` | No Relay mode or tool filters | No Relay sandbox override | Defer to the operator's backend configuration |
...
Relay rejects raw Claude or Codex permission flags in TOML so a route cannot
