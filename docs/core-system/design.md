...
**Author:** Ed Heltzel  **Date:** 2026-07-11

## Summary

relay is a local personal-assistant gateway. It owns channels, identity,
...
gateway core ---------------------------+
       |
       +-- SOUL.md       identity
       +-- relay.db       canonical conversation history
...
relay owns the footer so customising `SOUL.md` cannot accidentally disconnect
...
Approved by Ed Heltzel on 2026-07-11. Adopt `SOUL.md` as the single assistant
identity source and SQLite as Relay's canonical conversation history. Keep
