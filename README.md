...
Relay turns Claude Code or Codex into an always-on personal assistant. Run one
...
daily brief, or pick up a conversation from your phone. Relay owns the durable
...
you by iMessage or Telegram ─┐
                            ├─> Relay ─> Claude Code or Codex ─> reply to you
...
history, and delivery routes stay with Relay.
...
to choose a channel, configure a backend, run `relay doctor`, and keep the
gateway online.
